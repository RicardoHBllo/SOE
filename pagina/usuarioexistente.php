...
<div id="content">
  ...
  <div id="colTwo">
    ...
    <p><form action="registro2.php" method="POST" id="form">
		...
		<p>Nombre de usuario:
                <input type="text" name="usuario" size="50" placeholder="El nombre de usuario anterior ya existe, digite otro" required>
			    </br>
			    </br>
	  </p>
		<p>Password: 
		  <input type="password" name="password" size="50" required /></p>
		<p>Direccion:
		...
		<p>Correo:
		  <input type="email" name="mail" size="50" required>
		      </br>
		      </br>
	          </p>
