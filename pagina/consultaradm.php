...
<div id="content">
  ...
  <div id="colTwo">
	...
	echo "<table border='1'>";
	echo "<TR><TD> ID </TD><TD> Estatus </TD><TD> Nombre </TD><TD> Descripcion </TD><TD> Imagen </TD><TD> Fecha </TD></TR>";
	...
	while ($row=mysqli_fetch_array($result)) {
		...
		echo "<TR><TD> $id </TD><TD> $est </TD><TD> $nom </TD><TD> $des </TD><TD> <img src='mis_imagenes/$img' width='70' height='60'> </TD><TD> $fec </TD></TR>";
	}
